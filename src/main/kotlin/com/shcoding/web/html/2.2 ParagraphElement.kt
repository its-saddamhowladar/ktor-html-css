...
class ParagraphElement : Template<HTML> {
...
fun Routing.paragraphElement() {
    get(
        path = "/paragraph",
        body = {
            call.respondHtmlTemplate(template = ParagraphElement(), status = HttpStatusCode.PartialContent) {}
        }
    )
}