...
class VoidElement : Template<HTML> {
...
fun Routing.voidElement() {
    get(
        path = "/void",
        body = {
            call.respondHtmlTemplate(template = VoidElement(), status = HttpStatusCode.PartialContent) {}
        }
    )
}